Pulser Monitor — Detailed information
Created by Jan Moucka, ELI Laser

Bugs / suggestions: jan.moucka@eli-laser.eu
Verified against source: 2026-08-19  (pulser_monitor.py, 6901 lines)
-----------------------------------------------------------------
Short version: ReadMe_Pulser Monitor.txt  ("ReadMe" button)
...
the Launcher card and the built exe use it — until one is added, the card shows a
blank icon and the built program carries the default one.
